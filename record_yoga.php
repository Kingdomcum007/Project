...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO yoga_records (username, date, history) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sss", $username, $date, $history);
    if ($stmt->execute()) {
        $success = "บันทึกข้อมูล Yoga เรียบร้อยแล้ว!";
    } else {
...
<div class="container py-5">
    <div class="card shadow-lg p-4 mx-auto" style="max-width: 600px;">
        <div class="card-body">
            <h2 class="card-title text-center mb-4 text-success"><i class="fas fa-leaf me-2"></i>บันทึกประวัติการออกกำลังกาย Yoga</h2>
            ...
            <?php endif; ?>
            <form method="post" action="record_yoga.php">
                <div class="mb-3">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="history" name="history" rows="5" placeholder="เช่น โยคะร้อน 60 นาที, ท่าอาสนะพื้นฐาน" required></textarea>
                </div>
